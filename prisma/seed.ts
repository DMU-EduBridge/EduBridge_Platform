    ...
    const problems = await Promise.all([
      ...
      prisma.problem.create({
        data: {
          ...
          type: 'MULTIPLE_CHOICE',
          difficulty: 'HARD',
          options: JSON.stringify(['4', '2', '8', '6']),
          correctAnswer: '4',
      ...
      prisma.problem.create({
        data: {
          ...
          hints: JSON.stringify(['양변에서 3을 빼보세요', '양변을 2로 나누어보세요']),
          tags: JSON.stringify(['일차방정식', '수학']),
          points: 3,
          timeLimit: 180,
          isActive: true,
          isAIGenerated: false,
      ...
      prisma.problem.create({
        data: {
          ...
          hints: JSON.stringify(['피타고라스 정리를 사용해보세요', 'a² + b² = c²']),
          tags: JSON.stringify(['피타고라스', '수학', '기하']),
          points: 5,
          timeLimit: 300,
          isActive: true,
          isAIGenerated: false,
      ...
      prisma.problem.create({
        data: {
          ...
          hints: JSON.stringify(['뉴턴의 만유인력의 법칙을 생각해보세요', 'F = G(m₁m₂)/r²']),
          tags: JSON.stringify(['중력', '과학', '물리']),
          points: 5,
          timeLimit: 300,
          isActive: true,
          isAIGenerated: false,
      ...
      prisma.problem.create({
        data: {
          ...
          type: 'MULTIPLE_CHOICE',
          difficulty: 'EASY',
          options: JSON.stringify(['아름다운', '추한', '큰', '작은']),
          correctAnswer: '아름다운',
          explanation: '"beautiful"은 "아름다운"이라는 의미의 형용사입니다.',
          hints: JSON.stringify(['형용사의 의미를 생각해보세요']),
          tags: JSON.stringify(['영어', '단어', '형용사']),
          points: 2,
          timeLimit: 120,
          isActive: true,
          isAIGenerated: false,
